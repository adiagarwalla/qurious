...
class InClassView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            # mail them a message
            send_mail('Someone wants to have a session with you!', 'A user is waiting to have a one on one session with you! Come quickly, or else he may leave. The link to the session is http://qurious.info/dashboard/', 'quriousinc@gmail.com', [tutor.user.username], fail_silently=False)
