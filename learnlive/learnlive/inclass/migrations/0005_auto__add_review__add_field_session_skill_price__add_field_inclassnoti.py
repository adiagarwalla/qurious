...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Review'
        db.create_table(u'inclass_review', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rev_desc', self.gf('django.db.models.fields.TextField')()),
            ('rev_stars', self.gf('django.db.models.fields.IntegerField')()),
            ('tutor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.UserProfile'])),
        ))
        db.send_create_signal(u'inclass', ['Review'])

        # Adding field 'Session.skill_price'
        db.add_column(u'inclass_session', 'skill_price',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'InClassNotification.seen'
        db.add_column(u'inclass_inclassnotification', 'seen',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'inclass_review')

        # Deleting field 'Session.skill_price'
        db.delete_column(u'inclass_session', 'skill_price')

        # Deleting field 'InClassNotification.seen'
        db.delete_column(u'inclass_inclassnotification', 'seen')
    ...
    models = {
        ...
        u'inclass.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rev_desc': ('django.db.models.fields.TextField', [], {}),
            'rev_stars': ('django.db.models.fields.IntegerField', [], {}),
            'tutor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.UserProfile']"})
        },
        u'inclass.rsa': {
        ...
        u'inclass.session': {
            ...
            'skill_price': ('django.db.models.fields.IntegerField', [], {}),
