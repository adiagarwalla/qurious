...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inclass_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_from', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.UserProfile'])),
            ('user_from_name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('seq_number', self.gf('django.db.models.fields.IntegerField')()),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inclass.Session'])),
        ))
        db.send_create_signal(u'inclass', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table(u'inclass_message')
