    ...
    $.get('/dashboard/skills/', function(data) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            if (!data[i].fields.is_marketable) {
                $("#skill_set" + mod).append("<li class=\"active\"><input type=\"hidden\" value=\""+ data[i].pk +"\" /><a href=\"#\" data-toggle=\"modal\" data-target=\"#myModal\" class=\"modal_link\"><span class=\"badge pull-right\">" + "Not for sale" + "</span>" + data[i].fields.name + "</a></li>");
            } else {
                // alternative html goes here.
                $("#skill_set" + mod).append("<li class=\"active\"><input type=\"hidden\" value=\""+ data[i].pk +"\" /><a href=\"#\" data-toggle=\"modal\" data-target=\"#myModal\" style=\" background-color: rgb(201,62,59);\"><span class=\"badge pull-right\">" + "Sell for: $" + data[i].fields.price + "</span>" + data[i].fields.name + "</a></li>");
            }
        }
    });
}
